...
export async function generateMetadata(_props: TProps, parent: ResolvingMetadata): Promise<Metadata> {
  ...
  return {
    ...
    description: `Бесплатный онлайн-калькулятор для оценки стоимости обыкновенной акции по модели дисконтирования дивидендов Гордона (DDM, модель постоянного роста). Точно рассчитайте приведенную стоимость акции по формуле постоянного роста.`,
    keywords: [
      'калькулятор',
      'онлайн',
      'модель Гордона',
