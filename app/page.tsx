...
export default async function HomePage() {
  ...
  return (
    <PageShell initialDataContext={initialDataContext}>
      <p>
        «Инвестемика» — это бесплатный инструмент для частных инвесторов, представляющий ключевые финансовые показатели российских компаний
      ...
      <ul>
        ...
        <li className={linkClassName}>
          <Link href={EVA_CALCULATOR_URL}>Калькулятор EVA</Link>
        </li>
      </ul>
    </PageShell>
  );
